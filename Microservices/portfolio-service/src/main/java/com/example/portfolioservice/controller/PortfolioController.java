...
public class PortfolioController
{
                                   ...
                                   @QueryParam("secret") String secret_key, UserParser user)
    {
        ...
        if (Constants.SECRET_TOKEN.equals(secret_key)){
            if (user.all_funds().isPresent() && userId!=null){
                ...
                user = ImmutableUserParser.builder().userId(userId).currBal(user.currBal())
                            ...
                            @QueryParam("balance") float balance, @QueryParam("baseCurr") String baseCurr)
    {
        ...
        UserParser user = ImmutableUserParser.builder()
                .userId(userId)
                .baseCurr(baseCurr)
